...
:TODO-APP_DIR: ../packages/todo-app
...
[source,typescript]
----
include::{TODO-APP_DIR}/src/todo.tsx[]
----
...
[source,typescript]
----
include::{TODO-APP_DIR}/src/top.tsx[]
----
...
[source,typescript]
----
include::{TODO-APP_DIR}/src/layout.tsx[]
----
...
[source,typescript]
----
include::{TODO-APP_DIR}/src/task.tsx[]
----
...
[source,json]
----
include::{TODO-APP_DIR}/tsconfig.json[]
----
...
これがあるので `packages` ディレクトリの下にある `my-app` ディレクトリと `todo-app` ディレクトリがそれぞれ link:https://bun.com/docs/pm/workspaces[workspace] として認められることになります。
...
[source,typescript]
----
include::{TODO-APP_DIR}/tests/todo.e2e.ts[]
----
...
[source,typescript]
----
include::../packages/my-app/index.ts[]
----
